...
class ControllerExtensionModuleLivePrice extends liveopencart\lib\v0004\ControllerAdminExtension {
	
	protected $extension_code='liveprice';
    ...
    if (isset($this->error['warning'])) {
      ...
      unset($this->session->data['success']);
		...
		//$data['settings'] = array_merge($this->getCurrentPageSettings(), $this->getPageExtraData() );
		
		$this->setOutputStandard($data);
	}
	
	private function getPageExtraData($settings) {
		
		$settings = array_merge($settings, $this->model_extension_module_liveprice->readDBSettings());
