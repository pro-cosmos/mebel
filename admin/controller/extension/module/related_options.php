  ...
  public function index() {
    ...
    $this->load->model('extension/module/related_options');
      ...
      if (isset($this->request->post['variants'])) {
		...
		$data['version_pro']			= $this->model_extension_module_related_options->versionPRO();
    ...
    if (isset($this->request->post['related_options'])) {
		...
		$data['module_version'] = $this->model_extension_module_related_options->getCurrentVersion();
		/*
		...
		*/
		...
		$data['extension_code'] = $this->model_extension_module_related_options->getExtensionCode();
	...
	private function getFields($mod_language) {
		...
		if ( $this->model_extension_module_related_options->versionPRO() ) {
    ...
    $this->model_extension_module_related_options->install();
		...
		$msettings = array('related_options' => array('update_quantity'=>1,
																									...
																									'related_options_version'=>$this->model_extension_module_related_options->getCurrentVersion(),
																									));
